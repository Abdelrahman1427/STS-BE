...
{
    public class DisabilityService : CrudWithPaginateService<Disability>, IDisabilityService
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IHttpContextAccessor _context;

        public DisabilityService(IUnitOfWork unitOfWork, IHttpContextAccessor context) : base(unitOfWork)
        {
