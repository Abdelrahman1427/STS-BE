...
{
    public class PartnerService : CrudWithPaginateService<Partner>, IPartnerService
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IHttpContextAccessor _context;

        public PartnerService(IUnitOfWork unitOfWork, IHttpContextAccessor context) : base(unitOfWork)
        {
