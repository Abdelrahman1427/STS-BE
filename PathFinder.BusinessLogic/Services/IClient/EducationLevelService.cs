...
{
    public class EducationLevelService : CrudWithPaginateService<EducationLevel>, IEducationLevelService
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IHttpContextAccessor _context;

        public EducationLevelService(IUnitOfWork unitOfWork, IHttpContextAccessor context) : base(unitOfWork)
        {
