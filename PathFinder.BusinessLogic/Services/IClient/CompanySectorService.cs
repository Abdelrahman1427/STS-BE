...
{
    public class CompanySectorService : CrudWithPaginateService<CompanySector>, ICompanySectorService
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IHttpContextAccessor _context;

        public CompanySectorService(IUnitOfWork unitOfWork, IHttpContextAccessor context) : base(unitOfWork)
        {
