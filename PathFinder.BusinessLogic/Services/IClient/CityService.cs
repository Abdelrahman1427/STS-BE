...
{
    public class CityService : CrudWithPaginateService<City>, ICityService
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IHttpContextAccessor _context;

        public CityService(IUnitOfWork unitOfWork, IHttpContextAccessor context) : base(unitOfWork)
        {
