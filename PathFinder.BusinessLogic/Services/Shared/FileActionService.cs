...
{
    public class FileActionService : ILoggerTypeService
    {
        private readonly FileLogs _fileLogs;
            
        public FileActionService(FileLogs fileLogs)
        {
            _fileLogs = fileLogs;
        }
        ...
        public async Task<APIResult> SaveAction(Logger logger)
        {
            try
            {
                ...
                string folderName = AppContext.BaseDirectory + AppConstants.LoggerAction;
