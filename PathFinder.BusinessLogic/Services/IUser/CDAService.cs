...
{
    public class CDAService : CrudWithPaginateService<CommunityDevlopmentAssosition>, ICDAService
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IHttpContextAccessor _context;

        public CDAService(IUnitOfWork unitOfWork, IHttpContextAccessor context) : base(unitOfWork)
        {
