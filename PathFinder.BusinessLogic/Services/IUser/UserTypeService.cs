...
{
    public class UserTypeService : CrudWithPaginateService<UserType>, IUserTypeService
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IHttpContextAccessor _context;

        public UserTypeService(IUnitOfWork unitOfWork, IHttpContextAccessor context) : base(unitOfWork)
        {
